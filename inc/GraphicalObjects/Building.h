...
{
public:
	Building(uint16_t numberOfCubesOx, uint16_t numberOfCubesOy,
		uint16_t numberOfCubesOz, double cubeSize);
	...
	[[nodiscard]] const std::vector<bool>& GetCubesExistence() const;
